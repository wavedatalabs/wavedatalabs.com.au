...
With recent advances in AI technology, anyone can be a data scientist right? Just ask Chat-GPT.
...
Algorithmic fairness and biases are already huge issues which are only getting worse. Further reading on this topic is covered by Cathy O'Neil's excellent book *Weapons of Math Destruction: How Big Data Increases Inequality and Threatens Democracy*[^3].
...
-   If your model is a binary classification model, you should know what the 'null model' and whether it outperforms this.
